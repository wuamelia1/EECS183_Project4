...
void test_Line() {
    ...
    //test of function write
    Line line3(pt1, pt2, c1);
    fstream input_file;
    input_file.open("data1.txt");
    cout << "Expected: (0,0)  (0,5)  0  0  0, Actual: " << endl;
    line3.write(input_file);
}
...
void test_Triangle() {
    ...
    t2.setVertexOneColor(c1);
    cout << "Expected: 1  2  3, Actual: " << t2.getVertexOneColor() << endl;
    ...
    t2.setVertexTwoColor(c4);
    cout << "Expected: 0  0  0, Actual: : " << t2.getVertexTwoColor() << endl;
    ...
    t2.setVertexThreeColor(c5);
    cout << "Expected: (7, 255, 8), Actual: " << t2.getVertexThreeColor() << endl;

    //test of function setColor()
    t1.setColor(c1);
    cout << "Expected: (0,0)  1  2  3  (0,0)  1  2  3  (0,0)  1  2  3, Actual: " <<
        t1 << endl;
}
...
void test_Rectangle() {
    ...
    r1.setEnd(p3);
    cout << "Expected: (9,9), Actual: " << r1.getEnd() << endl;
    r1.setEnd(p1);
    cout << "Expected: (10,10), Actual: " << r1.getEnd() << endl;
    ...
    //test of function setColor
    r2.setColor(c1);
    cout << "Expected (10,10)  (20,30)  0  1  2  0  1  2  0  1  2  0  1  2, Actual: " << r2 << endl;
